            ...
            <div class="navbar-container">
                <div class="subheader" role="navigation">
                    <div id="stepTabs" class="navbar-collapse">
                        ...
                        <div class="tabTopStep1 <?php echo ($this->uri->uri_string() === 'step2') ? 'tabTopStep-SelectedStep' : '' ?>">
                            ...
                            <div class="<?php echo ($this->uri->uri_string() === 'step2') ? 'tabTopStepTextSelected' : 'tabTopStepText' ?>">Choose Plan</div>
                        </div>
                        <div class="tabTopStep1 <?php echo ($this->uri->uri_string() === 'step3') ? 'tabTopStep-SelectedStep' : '' ?>">
                            ...
                            <div class="<?php echo ($this->uri->uri_string() === 'step3') ? 'tabTopStepTextSelected' : 'tabTopStepText' ?>">Save Quote</div>
                        </div>
                    </div>
                </div>
                <div class="navbar-header" style="">
                    <a class="navbar-brand" href="tel:02-401-9189">
                        ...
                        <span class="navbar-tap visible-xs-inline-block"><i class="fa fa-phone"></i> Click Here</span><br><span class="navbar-number hidden-xs">02-401-9189</span></span>
                    </a>
                </div>
            </div>
        </div>
